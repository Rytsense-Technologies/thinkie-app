                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs text-gray-500 bg-gray-100 rounded-full border border-gray-300 px-2 py-1">
                        {skill.category}
                      </span>
                    </div>
            ...
            <div key={skill.id} className="flex items-start space-x-4">
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-xs font-bold text-red-500">Gap {skill.gap}</span>
                </div>
